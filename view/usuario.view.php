		...
		<div class="container">
			<div class="d-block d-md-flex bg-grad p-4 p-sm-5 all-text-white border-radius-3 pattern-overlay-3">
				<div class="align-self-center text-center text-md-left">
					<h3> <i class="fas fa-user-check fa-1x"></i> Gestión de docentes de la Escuela de Ingeniería de Sistemas</h3>
				</div>
				<div class="mt-3 mt-md-0 text-center text-md-right ml-md-auto align-self-center">
					<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal" id="btnagregar"><i class="fa fa-copy"></i> Agregar nuevo estudiante</button>
				</div>
			</div>
		</div>
	</section>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-4">
                                        ...
                                        <p >
                                            ...
                                            <select name="cboEspecialidad" id="cboEspecialidad" class="custom-select input-sm" required="" >
                                  ...
                                  <div class="col-md-4">
                                        ...
                                        <p>
                                            Número de especialidad <span style="color: red">*</span>
                                            <input type="text number" 
                                                          name="txtNroEspecialidad" 
                                                          id="txtNroEspecialidad" 
                                                          class="form-control input-sm text-bold"
                                                          required=""
                                        </p>
